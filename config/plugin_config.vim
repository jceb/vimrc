...
nnoremap <leader><leader>z :call <SID>ExecZeal(input('Zeal search: ', '', 'syntax'))<CR>
nnoremap <leader>z :silent call <SID>ExecZeal(<SID>GetZeavimDocset().'<cword>')<CR>
nnoremap <leader>Z :silent call <SID>ExecZeal('<cword>')<CR>
xnoremap <leader>z :<C-u>silent call <SID>ExecZeal(<SID>GetZeavimDocset().<SID>GetVisualSelection())<CR>
xnoremap <leader>Z :<C-u>silent call <SID>ExecZeal(<SID>GetVisualSelection())<CR>
