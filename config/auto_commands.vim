...
augroup ft_text
	au!
	au FileType help,debchangelog,tex,plaintex,txt,asciidoc,mkd,org		setlocal formatoptions=ltcrqnj nonumber norelativenumber
	...
	au FileType mail						setlocal cpoptions+=J comments+=b:-- spell spelllang=de iskeyword+=- nonumber norelativenumber formatoptions+=n formatlistpat=^\\s*\\(\\d\\+[\\]:.)}\\t\ ]\\\|[-*#]\\)\\s* | call formatmail#FormatMail()
