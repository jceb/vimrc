...
command! -nargs=0 ColorschemeCatppuccinMocha :silent! exec "PackerLoad catppuccin" | set background=dark | let g:blinds_guibg = "#414c61" | call luaeval("require('catppuccin').setup({ flavour = 'mocha'})") | colorscheme catppuccin-mocha | call UseTermBackground() | let g:lightline.colorscheme = "catppuccin" | call lightline#init() | call lightline#update() | hi Cursor guibg=#87afd7 | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
command! -nargs=0 ColorschemeCatppuccinMacchiato :silent! exec "PackerLoad catppuccin" | set background=dark | let g:blinds_guibg = "#414c61" | call luaeval("require('catppuccin').setup({ flavour = 'macchiato'})") | colorscheme catppuccin-macchiato | call UseTermBackground() | let g:lightline.colorscheme = "catppuccin" | call lightline#init() | call lightline#update() | hi Cursor guibg=#87afd7 | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
command! -nargs=0 ColorschemeCatppuccinFrappe :silent! exec "PackerLoad catppuccin" | set background=dark | let g:blinds_guibg = "#414c61" | call luaeval("require('catppuccin').setup({ flavour = 'frappe'})") | colorscheme catppuccin-frappe | call UseTermBackground() | let g:lightline.colorscheme = "catppuccin" | call lightline#init() | call lightline#update() | hi Cursor guibg=#87afd7 | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
command! -nargs=0 ColorschemeCatppuccinLatte :silent! exec "PackerLoad catppuccin" | set background=light | let g:blinds_guibg = "#cdcdcd" | colorscheme catppuccin-latte | call UseTermBackground() | let g:lightline.colorscheme = "catppuccin" | call lightline#init() | call lightline#update() | hi Cursor guibg=#87afd7 | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
command! -nargs=0 ColorschemePaperColor :silent! exec "PackerLoad papercolor" | set background=light | let g:blinds_guibg = "#cdcdcd" | colorscheme PaperColor | call UseTermBackground() | let g:lightline.colorscheme = "PaperColor_light" | call lightline#init() | call lightline#update() | hi Cursor guibg=#87afd7 | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
command! -nargs=0 ColorschemeNord :silent! exec "PackerLoad nord" | set background=dark | let g:blinds_guibg = "#414c61" | colorscheme nord | call UseTermBackground() | let g:lightline.colorscheme = "nord" | call lightline#init() | call lightline#update() | hi Cursor guibg=#87afd7 | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
command! -nargs=0 ColorschemeTokyoNight :silent! exec "PackerLoad tokyonight" | let g:tokyonight_style = "night" | set background=dark | let g:blinds_guibg = "#414c61" | colorscheme mytokyonight | call UseTermBackground() | let g:lightline.colorscheme = "tokyonight" | call lightline#init() | runtime autoload/lightline/colorscheme/tokyonight.vim | call lightline#update() | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
command! -nargs=0 ColorschemeTokyoStorm :silent! exec "PackerLoad tokyonight" | let g:tokyonight_style = "storm" | set background=dark | let g:blinds_guibg = "#414c61" | colorscheme mytokyonight | call UseTermBackground() | let g:lightline.colorscheme = "tokyonight" | call lightline#init() | runtime autoload/lightline/colorscheme/tokyonight.vim | call lightline#update() | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
command! -nargs=0 ColorschemeTokyoDay :silent! exec "PackerLoad tokyonight" | let g:tokyonight_style = "day" | set background=light | let g:blinds_guibg = "#cdcdcd" | colorscheme mytokyonight | call UseTermBackground() | let g:lightline.colorscheme = "tokyonight" | call lightline#init() | runtime autoload/lightline/colorscheme/tokyonight.vim | call lightline#update() | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
command! -nargs=0 ColorschemeTokyoMoon :silent! exec "PackerLoad tokyonight" | let g:tokyonight_style = "moon" | set background=light | let g:blinds_guibg = "#cdcdcd" | colorscheme mytokyonight | call UseTermBackground() | let g:lightline.colorscheme = "tokyonight" | call lightline#init() | runtime autoload/lightline/colorscheme/tokyonight.vim | call lightline#update() | hi clear MiniCursorword | hi clear MiniCursorwordCurrent
