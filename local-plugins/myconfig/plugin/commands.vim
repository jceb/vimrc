...
command! -nargs=0 ColorschemeCatppuccinLatte :silent! exec "PackerLoad catppuccin" | set background=light | let g:blinds_guibg = "#cdcdcd" | colorscheme catppuccin-latte | call UseTermBackground() | let g:lightline.colorscheme = "PaperColor_light" | call lightline#init() | call lightline#update() | hi Cursor guibg=#87afd7
