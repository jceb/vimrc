...
map("n", "<Space>ce", ":<C-u>e %/", { noremap = true })
map("n", "<Space>ch", ":<C-u>e ~/", { noremap = true })
map("n", "<Space>co", ":<C-u>e ~/.config/", { noremap = true })
map("n", "<Space>ct", ":<C-u>e /tmp", { noremap = true })
...
map("n", "<Space>fp", ":<C-u>Telescope find_files hidden=true cwd=", { noremap = true })
