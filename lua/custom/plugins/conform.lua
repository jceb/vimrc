return {
  ...
  opts = {
    ...
    formatters_by_ft = {
      ...
      python = { "black", "yapf" },
      rust = { "rustfmt" },
      sass = { "deno_fmt", "prettierd", "prettier" },
      scss = { "deno_fmt", "prettierd", "prettier" },
      sh = { "shellcheck" },
      svelte = { "deno_fmt", "prettierd", "prettier" },
      typescript = { "deno_fmt", "prettierd", "prettier" },
      typescriptreact = { "deno_fmt", "prettierd", "prettier" },
      vue = { "deno_fmt", "prettierd", "prettier" },
      xml = { "xmllint", "xmlformat", "prettierd", "prettier" },
      yaml = { "deno_fmt", "prettierd", "prettier", "yamlfmt", "yq" },
    },
    default_format_opts = {
      lsp_format = "fallback",
