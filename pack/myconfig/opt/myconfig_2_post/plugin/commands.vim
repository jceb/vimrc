...
command! -nargs=0 ColorschemeTokyoDay :silent! exec "PackerLoad tokyonight" | let g:tokyonight_style = "day" | set background=light | let g:blinds_guibg = "#cdcdcd" | colorscheme tokyonight | call UseTermBackground() | let g:lightline.colorscheme = "tokyonight" | call lightline#init() | runtime autoload/lightline/colorscheme/tokyonight.vim | call lightline#update()
