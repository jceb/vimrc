...
augroup ft_text
	...
	au FileType mail						setlocal cpoptions+=J commentstring=>%s comments+=b:-- spell spelllang=de iskeyword+=- formatoptions+=n formatlistpat=^\\s*\\(\\d\\+[\\]:.)}\\t\ ]\\\|[-*#]\\)\\s*| call formatmail#FormatMail()
augroup END
